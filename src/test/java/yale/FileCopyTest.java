...
public class FileCopyTest {
    ...
    public void test() {
        ...
        final String converted = f.convertSharePath(FilenameUtils.separatorsToUnix(servicePath), clientSourcePath);
    ...
    public void test2() {
        ...
        final String converted = f2.convertSharePath(FilenameUtils.separatorsToUnix(servicePath), clientSourcePath);
        assertTrue (converted.equals(desired));
    }
